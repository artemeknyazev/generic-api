const { ValidationError } = require('src/helpers')
...
module.exports = function errorHandler(err, req, res, next) { // eslint-disable-line no-unused-vars
  ...
  // NOTE: error payload is always a list of error messages
  let statusCode = 500
  ...
  if (err) {
    ...
    if (err instanceof HttpError) {
      ...
      statusCode = 400
      payload = err.toJSON() // Will always produce an array of errors
    } else if (
